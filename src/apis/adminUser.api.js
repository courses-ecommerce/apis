...
// adminUserApis.get('/:id', adminUserController.getDetailAccountAndUser)
...
// adminUserApis.put('/:id', adminUserController.putAccountAndUser)
...
// adminUserApis.delete('/multiple', adminUserController.deleteMultiAccountAndUser)
